...
const Anchor = (props : any) => {
  ...
  return (
    <chakra.a
      color={mode('orange.500', 'orange.300')({ colorMode })}
...
const MDXComponents = {
  ...
  td: TData,
  a: Anchor,
  p: (props : any) => <chakra.p apply="mdx.p" fontSize="xl" {...props} />,
  ul: (props : any) => <chakra.ul px={{ base: 4, md: 8 }} apply="mdx.ul" {...props} />,
  ol: (props : any) => <chakra.ol apply="mdx.ul" {...props} />,
  li: (props : any) => <chakra.li pb="4px" fontSize="lg" {...props} />,
